...
public class LinkedList {
    ...
    public Node getHead(){   //return type Node means it return a node
    ...
    public void makeEmpty(){  //makes the linked list empty by clearing the initial argument passed during object creation in main method
        head = null;
        tail = null;
        length = 0;
    }
